...
var EngineLoader = {
    ...
    loadAndInstantiateWasmAsync: function(src, fromProgress, toProgress, callback) {
        FileLoader.load(src, "arraybuffer", EngineLoader.wasm_size,
            ...
            function(wasm) {
                Module.instantiateWasm = function(# import removeds, successCallback) {
                    var wasmInstantiate = WebAssembly.instantiate(new Uint8Array(wasm), # import removeds).then(function(output) {
    ...
    setupWasmStreamAsync: async function(src, fromProgress, toProgress) {
        ...
        Module.instantiateWasm = function(# import removeds, successCallback) {
            WebAssembly.instantiateStreaming(fetchFn(src), # import removeds).then(function(output) {
